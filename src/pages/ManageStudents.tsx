    ...
    <div className="mx-auto w-full max-w-4xl xl:max-w-5xl 2xl:max-w-6xl">
      <div className="mb-6 flex flex-wrap items-center justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-sm text-slate-500">Add, edit, and delete student accounts</p>
        </div>
      ...
      <div className="flex flex-col gap-3">
        {students.map((student) => {
          ...
          return (
            <Card key={student._id} className="flex flex-wrap items-center justify-between gap-4 px-5 py-4">
              {isEditing ? (
